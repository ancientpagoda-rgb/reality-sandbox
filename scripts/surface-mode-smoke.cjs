...
(async () => {
  ...
  try {
    ...
    assert(after.build === 'surface-v47e-lineage-population-record', `Unexpected build ${after.build}`);
    ...
    await page.screenshot({ path: path.join(artifactDir, 'surface-mode-v47e-lineage-population-record.png'), fullPage: true });
